...
interface ScoredShardsPerPortalPerWaveContext {
    scoredShardsPerPortalPerWave: Map<number, Map<PortalId, Set<number>>>;
}
...
const scoreMove = (
    ...
    context: ScoredShardsPerPortalPerWaveContext,
    total: Record<FactionId, number>,
    jumpsSummary: Record<FactionId, number>,
    jumpsDetail: Record<string, Record<FactionId, number>>,
    goalsSummary: Record<FactionId, number>,
    goalsDetail: Record<string, Record<FactionId, number>>
): void => {
    ...
    for (const [ruleKey, rule] of Object.entries(rules)) {
        ...
        if (rule.maxScoringShardsPerPortal !== undefined) {
            const scoredShardsPerPortalPerWave = context.scoredShardsPerPortalPerWave;
